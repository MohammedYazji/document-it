...
@section('content')
  <article class="mx-auto article-column px-margin-mobile md:px-0">
    <!-- Headline -->
    <header class="mb-12">
      <h1 class="font-display-lg text-display-lg mb-8 text-on-surface">The Architecture of Silence: Designing for Focused
        Cognition</h1>
      <!-- Author Bio -->
    ...
    <div class="space-y-8">
      <p class="font-body-lg text-body-lg text-on-surface leading-relaxed">
        In an era defined by the constant hum of notification-driven anxiety, the true luxury of the modern interface is
        not feature density, but intentional absence. We have spent decades filling every pixel with utility, forgetting
        that the primary purpose of reading is a solitary, quiet dialogue between the ink and the mind.
      </p>
      <h2 class="font-headline-md text-headline-md mt-12 mb-4 text-on-surface">The Psychology of White Space</h2>
      <p class="font-body-md text-body-md text-on-surface">
        When we strip away the secondary sidebars, the flashing banners, and the sticky social widgets, we allow the
        reader's cognitive load to reset. This isn't just a stylistic choice; it's a neurological necessity for deep
        comprehension. The grid must breathe.
      </p>
      <div class="my-12">
      ...
      <blockquote class="pl-6 border-l-4 border-primary my-12 italic">
        <p class="font-body-lg text-body-lg text-on-surface">"True design is reached not when there is nothing left to
          add, but when there is nothing left to take away from the core message."</p>
      </blockquote>
      <h3 class="font-ui-label text-ui-label font-bold uppercase tracking-wider text-primary">Intentional Constraints</h3>
      <p class="font-body-md text-body-md text-on-surface">
        Standardizing column widths to 720px is more than a convention. It respects the physiological limits of the human
        eye, ensuring that the transition from the end of one line to the beginning of the next remains fluid and
        effortless. Any wider, and the brain begins to work too hard just to track the sequence.
      </p>
