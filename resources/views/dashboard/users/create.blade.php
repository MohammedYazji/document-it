<x-layout title="Create User">
    ...
    <main class="flex-grow w-full max-w-container-max mx-auto px-gutter py-12 pt-24">
        <div class="mb-8">
            ...
            <h1 class="font-display-lg text-[36px] text-on-background leading-tight mt-2">Create User</h1>
        </div>

        <form action="{{ route('admin.users.store') }}" method="POST" class="max-w-lg bg-surface-container-lowest border border-outline-variant rounded-2xl p-8">
            @csrf
            ...
            <div class="mb-4">
                <label class="font-ui-label text-ui-label text-on-surface mb-1 block">Password</label>
